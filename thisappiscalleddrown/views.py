...
class IndexView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context[
            "description"
        ] = "thisappiscalleddrown vous permet de planifier vos activités de groupe avec facilité sur le Web 2.0"
...
class InscriptionsTemplateView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context[
            "desc"
        ] = "Disclaimer: Ceci est une demo d'implémentation différente, plus propre et plus DRY d'affichage \
...
class ActivityDetailView(LoginRequiredMixin, DetailView):
    ...
    **Template**
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "thisappiscalleddrown"
        context["description"] = "La page détail d'une activités sur thisappiscalleddrown"
...
class ActivityCreateView(LoginRequiredMixin, CreateView):
    ...
    **Template**
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "thisappiscalleddrown"
        context["description"] = "Créer une activité sur thisappiscalleddrown"
        return context
...
class ActivityUpdateView(LoginRequiredMixin, UpdateView):
    ...
    **Template**
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "thisappiscalleddrown"
        context["description"] = "Modifier une activité sur thisappiscalleddrown"
        return context
...
class ActivityDeleteView(LoginRequiredMixin, DeleteView):
    ...
    **Template**
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "thisappiscalleddrown"
        context["description"] = "Supprime une activité sur thisappiscalleddrown"
        return context
...
class GroupDetailView(LoginRequiredMixin, DetailView):
    ...
    **Contexte**
    ...
    ``upcoming_activities``
        Activités de groupes futures. Liste de :model:`thisappiscalleddrown.Activity`
    ``invitation_form``
...
class GroupCreateView(LoginRequiredMixin, CreateView):
    ...
    **Template**
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "thisappiscalleddrown"
        context["description"] = "Créer un groupe sur thisappiscalleddrown"
        return context
...
class ContributorsView(TemplateView):
    ...
    **Contexte**
    ...
    ``description``
        Description de la page.
    ``contributors``
        Contributeurs à thisappiscalleddrown.
...
class ConditionsView(TemplateView):
    ...
    **Template**
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "thisappiscalleddrown"
        context["description"] = "Conditions générales d'utilisation de thisappiscalleddrown."
        return context
...
class ConfidentialityView(TemplateView):
    ...
    **Template**
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "thisappiscalleddrown"
        context["description"] = "Confidentialité de thisappiscalleddrown"
        return context
