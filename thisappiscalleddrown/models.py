...
class Group(models.Model):
    """
    Modèle représentant un groupe thisappiscalleddrown.
    """
    ...
    def get_absolute_url(self):
        return reverse("thisappiscalleddrown:group_detail", kwargs={"slug": self.slug})

    def get_add_url(self):
        return reverse("thisappiscalleddrown:add_group", kwargs={"slug": self.slug})

    def get_update_url(self):
        return reverse("thisappiscalleddrown:update_group", kwargs={"slug": self.slug})

    def get_confirm_delete_url(self):
        return reverse("thisappiscalleddrown:group_confirm_delete", kwargs={"slug": self.slug})
...
class Activity(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("thisappiscalleddrown:activity_detail", kwargs={"slug": self.slug})

    def get_clone_old_url(self):
        return reverse("thisappiscalleddrown:clone_activity", kwargs={"slug": self.slug})

    def get_clone_url(self):
        return reverse("thisappiscalleddrown:clone_activity_ajax", kwargs={"slug": self.slug})

    def get_update_url(self):
        return reverse("thisappiscalleddrown:update_activity", kwargs={"slug": self.slug})

    def get_confirm_delete_url(self):
        return reverse("thisappiscalleddrown:activity_confirm_delete", kwargs={"slug": self.slug})
...
class Inscription(models.Model):
    ...
    def get_absolute_url(self):
        return reverse_lazy("thisappiscalleddrown:inscription", kwargs={"slug": self.slug})
...
class Invitation(models.Model):
    ...
    def get_absolute_url(self):
        return reverse_lazy("thisappiscalleddrown:invitation", kwargs={"slug": self.slug})
