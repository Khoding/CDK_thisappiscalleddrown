...
from thisappiscalleddrown.models import Invitation
...
class UserProfileView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        if "disconnectUser" in self.request.POST:
            ...
            return redirect("thisappiscalleddrown:homepage")
...
class SignupView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Compte"
        context["description"] = "Créer un compte sur thisappiscalleddrown."
...
class UserLoginView(SuccessMessageMixin, LoginView):
    ...
    success_url = reverse_lazy("thisappiscalleddrown:index")
    ...
    def get_context_data(self, **kwargs):
        ...
        context["title"] = "Compte"
        context["description"] = "Se connecter à son compte sur thisappiscalleddrown."
        return context
