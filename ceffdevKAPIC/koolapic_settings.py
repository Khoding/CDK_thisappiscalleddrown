...
CONTRIBUTORS = [
    {
        ...
        'year_when_contr': 3,
        'contribs': [{'name': '"Initiateur" du projet refonte', 'desc': 'A proposé Django, ce qui a mené à la refonte',
                      'credits': 75}, {'name': 'Développeur', 'desc': 'A contribué au code', 'credits': 200},
    ...
    },
    {
        ...
        'year_when_contr': 4,
        'contribs': [
            {'name': 'Plus grand contributeur', 'desc': 'A apporté la contribution la plus conséquente au projet',
             'credits': 500}, {'name': 'Designer Principal', 'desc': 'A créé le design', 'credits': 250},
    ...
    },
    {
        ...
        'year_when_contr': 4,
        'contribs': [{'name': 'Développeur', 'desc': 'A contribué au code', 'credits': 200},
    ...
    },
    {
        ...
        'year_when_contr': 4,
        'contribs': [
            {'name': 'Migrations des données depuis l\'ancien site', 'desc': 'A créé le script de migration (2x)',
             'credits': 250}, {'name': 'Développeur', 'desc': 'A contribué au code', 'credits': 100}],
