...
CONTRIBUTORS = [
    ...
    },
    {
        ...
        'year_when_contr': 4,
        'contribs': [{'name': 'Plus grand contributeur', 'desc': 'A apporté la contribution la plus conséquente au projet', 'credits': 500}, {'name': 'Designer Principal', 'desc': 'A créé le design', 'credits': 250}, {'name': 'Développeur', 'desc': 'A contribué au code', 'credits': 200}],
